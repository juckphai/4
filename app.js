document.addEventListener('DOMContentLoaded', () => {
    ...
    const App = {
        ...
        editingStockInId: null, // For tracking stock-in edits
        ...
        // --- START: NEW CRYPTO HELPER FUNCTIONS ---
        ...
        // --- END: NEW CRYPTO HELPER FUNCTIONS ---
        ...
        fillPages(){ 
            ...
            document.getElementById('page-summary').innerHTML = `
                ...
                <div class="summary-section" id="admin-report-filters">
                    ...
                    <div id="report-filter-content" class="collapsible-content active" style="padding: 20px; background-color: #fafafa; display: grid; gap: 15px;">
                        <div class="summary-form-inline">
                            <label for="summary-seller-select">ผู้ขาย:</label>
                            <select id="summary-seller-select" style="text-align: left;"></select>
                        </div>
                        <div class="summary-form-inline">
                ...
                <div class="summary-section" id="admin-report-actions">
                    ...
                    <div class="report-action-buttons">
                        ...
                        <div class="report-action-item">
                            <p><strong>สรุปภาพรวม (แบบเดิม)</strong><br><small>(สรุปยอดขาย, กำไร, จำนวนสินค้า)</small></p>
            ...
            <!-- START: NEW SELLER DETAILED REPORT SECTION -->
            ...
            <!-- END: NEW SELLER DETAILED REPORT SECTION -->

            <!-- START: NEW SELLER CREDIT REPORT SECTION -->
            ...
            <!-- END: NEW SELLER CREDIT REPORT SECTION -->

            <!-- START: NEW SELLER TRANSFER REPORT SECTION -->
            ...
            <!-- END: NEW SELLER TRANSFER REPORT SECTION -->
        ...
        attachEventListeners(){ 
            ...
            mainApp.addEventListener('click', (e) => { 
                ...
                if (e.target.id === 'generate-aggregated-summary-btn') this.runAdminAggregatedSummary();
            }); 
